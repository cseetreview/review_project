...
// Task 2
"Task 2: Include a constructor to initialize <strong>preferences</strong> and <strong>maxAdvs</strong> with its two parameters, setting <strong>advertisements</strong> as an empty list.",
